...
export function DeepResearchModal({
 ...
 {noProvidersActive ? (
 <div className="mx-4 sm:mx-6 mt-4 mb-0 p-4 border border-warning/40 bg-warning/10 text-warning rounded-xl">
 ...
 className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 bg-amber-900 dark:bg-amber-200 text-warning-fg hover:bg-amber-800 dark:hover:bg-amber-100 transition-colors rounded-md"
 >
 ...
 {/* Search bar area */}
 <div className="px-4 sm:px-6 py-4 border-y border-gray-100 dark:border-gray-800 shrink-0 bg-gray-50/50 dark:bg-canvas/30">
 <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
 <div className="flex-1 relative">
 <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-fg-muted text-xl">
 search
 </span>
 <input
 value={query}
 ...
 <div className="flex p-1 bg-border-subtle/70 dark:bg-border-strong rounded-lg shrink-0">
 <button
 type="button"
 ...
 : noProvidersActive
 ? "bg-gray-300 dark:bg-border-strong text-fg-muted cursor-not-allowed"
 : "bg-accent hover:from-indigo-700 hover:to-purple-700 text-white shadow-accent/25"
 }`}
 >
 {running ? (
 ...
 {/* Left: Plan + Activity */}
 <div className="md:border-r border-b md:border-b-0 border-gray-100 dark:border-gray-800 overflow-y-auto p-4 space-y-5 bg-gray-50/30 dark:bg-canvas/20">
 {plan.length > 0 && (
 <div>
 <h3 className="text-[11px] font-semibold uppercase tracking-wider text-fg-muted mb-3 flex items-center gap-1.5">
 <span className="material-symbols-outlined text-sm">
 checklist
 </span>
 Research Plan
 ...
 <div className="text-[11px] font-mono text-fg-muted space-y-1 bg-accent-soft/70 dark:bg-elevated/50 rounded-lg p-3 border border-border-subtle/50 dark:border-border-strong/30">
 {logs.map((l, i) => (
 <div
 key={`${i}-${l.slice(0, 12)}`}
 ...
 {running && (
 <div className="flex items-center gap-2 text-xs text-fg-accent pt-2">
 <span className="material-symbols-outlined text-sm animate-spin">
 progress_activity
 </span>
 <span>Working...</span>
 ...
 <div className="h-6 bg-border-subtle rounded-lg w-3/4" />
 <div className="space-y-2">
 <div className="h-4 bg-accent-soft rounded w-full" />
 <div className="h-4 bg-accent-soft rounded w-5/6" />
 <div className="h-4 bg-accent-soft rounded w-4/6" />
 </div>
 <div className="h-4 bg-accent-soft rounded w-2/3 mt-6" />
 <div className="space-y-2">
 <div className="h-4 bg-accent-soft rounded w-full" />
 <div className="h-4 bg-accent-soft rounded w-5/6" />
 </div>
 ...
 {/* Right: Sources */}
 <div className="md:border-l border-t md:border-t-0 border-gray-100 dark:border-gray-800 overflow-y-auto p-4 bg-gray-50/30 dark:bg-canvas/20">
 <div className="flex items-center justify-between mb-3">
 <h3 className="text-[11px] font-semibold uppercase tracking-wider text-fg-muted flex items-center gap-1.5">
 ...
 className="text-[11px] px-3 py-1 rounded-full bg-accent hover:from-indigo-700 hover:to-purple-700 text-white font-medium disabled:opacity-50 transition-all shadow-sm shadow-indigo-500/20"
 >
 Add all
 </button>
 )}
 ...
 <p className="font-medium line-clamp-2 text-fg-secondary leading-relaxed">
 {s.title}
 </p>
 <a
 href={s.url}
 target="_blank"
 rel="noreferrer"
 className="text-fg-accent hover:text-fg-accent dark:hover:text-indigo-300 hover:underline truncate block mt-1"
 >
 ...
 type="button"
 onClick={() => addOne(s)}
 className="text-[10px] px-2.5 py-1 rounded-full bg-accent-soft dark:bg-indigo-900/30 text-fg-accent hover:bg-indigo-100 dark:hover:bg-indigo-900/50 font-medium transition-colors shrink-0"
 >
 Add
 </button>
 </div>
 ...
 {/* Footer */}
 <div className="px-6 py-3 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-canvas/30 flex items-center justify-between shrink-0">
 ...
 className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium bg-accent hover:from-indigo-700 hover:to-purple-700 text-white transition-all shadow-sm disabled:opacity-50"
 >
 <span className="material-symbols-outlined text-sm">
 add_circle
 </span>
