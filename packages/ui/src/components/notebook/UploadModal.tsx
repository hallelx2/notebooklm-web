...
export function UploadModal({
 ...
 className="p-2 rounded-full hover:bg-accent-soft dark:hover:bg-border-strong text-fg-muted"
 >
 <span className="material-symbols-outlined">close</span>
 </button>
 </div>
 <div className="flex px-4 sm:px-6 pt-2 border-b border-gray-100 dark:border-border-subtle shrink-0 gap-4 sm:gap-8 overflow-x-auto">
 {(
 [
 ...
 : "bg-fg-accent hover:bg-accent-hover text-fg-on-accent"
 }`}
 >
 ...
 <div className="rounded-lg bg-accent-soft/80 dark:bg-black/20 p-3 max-h-52 overflow-y-auto space-y-1.5">
 {logs.map((l, i) => {
 ...
 >
 {isStage && (
 <span className="material-symbols-outlined text-[11px] text-fg-accent mt-0.5 shrink-0">
 arrow_right
 </span>
 )}
 ...
 {running && (
 <div className="flex items-center gap-1.5 pt-1 border-t border-border-subtle/50 dark:border-white/5 mt-1">
 <span className="material-symbols-outlined text-xs animate-spin text-fg-accent">
 progress_activity
 </span>
 <span className="text-[10px] font-medium text-fg-accent">
 Working...
 </span>
 </div>
 )}
 ...
 {sources.length > 0 && (
 <div>
 <h4 className="text-[10px] uppercase tracking-widest text-fg-muted mb-2">
 ...
 target="_blank"
 rel="noreferrer"
 className="p-2 rounded-lg border border-border-subtle text-xs hover:border-blue-400"
 >
 <div className="flex items-start gap-2">
 <span className="font-mono text-[9px] text-fg-muted mt-0.5">
 [{s.n}]
 </span>
 <div className="flex-1 min-w-0">
 <p className="font-medium line-clamp-2 text-fg-secondary">
 {s.title}
 </p>
