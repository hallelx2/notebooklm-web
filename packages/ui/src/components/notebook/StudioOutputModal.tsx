...
const KIND_COLORS: Record<string, string> = {
 ...
 "study-guide":
 "bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-fg-accent",
 "briefing-doc":
 ...
 "mind-map":
 "bg-indigo-100 text-indigo-700 dark:bg-accent-soft0/20 dark:text-indigo-300",
 flashcards:
...
export function StudioOutputModal({
 ...
 const colorClass =
 KIND_COLORS[kind] ??
 "bg-accent-soft text-fg-secondary dark:bg-gray-500/20 dark:text-fg-secondary";

 function renderBody() {
 if (output.status === "generating") {
 return (
 <div className="flex flex-col items-center justify-center py-16 gap-3">
 <span className="material-symbols-outlined text-4xl text-fg-muted animate-spin">
 progress_activity
 </span>
 ...
 <h2 className="text-lg font-semibold text-fg-secondary truncate">
 {output.title}
 </h2>
 <span
 ...
 type="button"
 onClick={onClose}
 className="p-2 rounded-full hover:bg-accent-soft dark:hover:bg-border-strong text-fg-muted transition-colors"
 title="Close"
 >
