...
function TextContent({ text }: { text: string }) {
 return (
 <div className="prose prose-sm dark:prose-invert max-w-none prose-p:my-2 prose-headings:my-3 prose-ul:my-2 prose-ol:my-2 prose-li:my-0.5 prose-pre:bg-accent-soft dark:prose-pre:bg-elevated prose-pre:rounded-lg">
...
function FlashcardsContent({
 ...
 className="px-4 py-2 rounded-full bg-indigo-100 dark:bg-accent-soft0/20 text-fg-accent text-xs font-medium hover:bg-indigo-200 dark:hover:bg-accent-soft0/30 transition-colors"
 >
 Flip card
 </button>
...
function QuizContent({
 ...
 const scoreBorder =
 pct >= 70
 ? "border-emerald-300 dark:border-success/30"
 : pct >= 50
 ? "border-warning/30"
 : "border-red-300 dark:border-danger/30";
 const encouragement =
 pct === 100
 ...
 <span className="text-2xl font-medium text-fg-muted">
 /{total}
 </span>
 </div>
 ...
 type="button"
 onClick={retake}
 className="w-full py-3 rounded-xl border-2 border-amber-400 dark:border-warning/40 text-warning dark:text-amber-400 text-sm font-semibold hover:bg-amber-50 dark:hover:bg-warning/10 transition-colors flex items-center justify-center gap-2"
 >
 ...
 letterStyle =
 "border-red-500 text-danger bg-red-50 dark:bg-red-500/20";
 iconEl = (
 ...
 {/* Keyboard hint */}
 <p className="mt-3 text-[10px] text-fg-muted text-center">
...
export function StudioOutputView({ output, onNodeClick }: Props) {
 ...
 <span className="material-symbols-outlined text-4xl text-fg-accent animate-spin">
 progress_activity
 </span>
