...
export function MindMapRenderer({ markdown, onNodeClick }: Props) {
 ...
 {/* ---------- Hint ---------- */}
 {!loading && onNodeClick && (
 <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center justify-center gap-2 py-2 px-4 rounded-full bg-accent-soft border border-fg-accent/20 w-fit">
 <span className="material-symbols-outlined text-[16px] text-fg-accent">
 touch_app
 </span>
