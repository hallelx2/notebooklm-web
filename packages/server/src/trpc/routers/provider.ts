...
} from "@notebooklm/core/ai/factory";
import {
  getProvider,
  isValidProviderId,
  PROVIDERS,
...
import {
  IdResultSchema,
  ProviderCredentialMaskedSchema,
...
export const providerRouter = router({
  ...
  upsert: protectedProcedure
    ...
    .output(ProviderCredentialMaskedSchema)
    .mutation(async ({ input, ctx }) => {
      ...
      const [created] = await ctx.adapter.db
